...
# Polynomial GNN Layer
# m = a0*h + a1*Lh + a2*L^2 h
class PolyLayer(nn.Module):
    ...
    def forward(self, h, L):
        ...
        m = self.a0 * h + self.a1 * Lh + self.a2 * L2h + self.a3 * L3h
...
# Full Model (2 stacked layers)
class PolyGNN(nn.Module):
    def __init__(self, in_dim, hidden_dim, num_classes):
        super().__init__()
        self.layer1 = PolyLayer(in_dim, hidden_dim, hidden_dim)
        self.layer2 = PolyLayer(hidden_dim, hidden_dim, num_classes)
